...
Example::
    ...
    from cognity_ai.multimodal.transcribers.whisper_local import WhisperLocalTranscriber
...
from cognity_ai.multimodal.models.media import AudioChunk, AudioSegment
...
if TYPE_CHECKING:
    ...
    from cognity_ai.multimodal.loaders.audio import AudioLoader
...
class AudioIngestionPipeline:
    ...
    def loader(self) -> "AudioLoader":
        if self._loader is None:
            from cognity_ai.multimodal.loaders.audio import AudioLoader  # lazy import
